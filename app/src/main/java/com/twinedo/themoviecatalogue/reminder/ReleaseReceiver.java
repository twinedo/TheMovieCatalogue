...
public class ReleaseReceiver extends BroadcastReceiver {
    ...
    public static final String TYPE_REPEATING = "Let's check TheMovieCatalogue";
    public static final String EXTRA_MESSAGE = "message";
    public static final String EXTRA_TYPE = "type";

    private static final int ID_ONETIME = 200;
    private static final int ID_REPEATING = 201;
   ...
   // private static final String TAG = ReleaseReceiver.class.getSimpleName();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Objects.requireNonNull(intent.getStringExtra(EXTRA_MESSAGE)).isEmpty()) {
            String message = intent.getStringExtra(EXTRA_MESSAGE);
            showAlarmNotification(context, message);
        } else {
            String message = intent.getStringExtra(EXTRA_MESSAGE+"no Movie released today");
            showAlarmNotification(context, message);
        }
    }
    ...
    private void showAlarmNotification(Context context, String title) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setContentText(ReleaseReceiver.TYPE_REPEATING)
        ...
        if (notificationManager != null) {
            notificationManager.notify(ReleaseReceiver.ID_REPEATING, notification);
        }
    }

    public void setRepeatingRelease(Context context, String type, String time, String message) {
